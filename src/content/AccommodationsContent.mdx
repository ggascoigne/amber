...
Resort in Troutdale for its <AcnwOrdinal/> year. This superb historic hotel complex includes a
...
Game Rooms: These are suites reserved for game play and the listed price
includes a {configuration.gameRoomSubsidy} discount from ACNW for gaming
nights. While we will do our best to use the rooms for games you are in,
in exchange for the discount the game space will be scheduled **at the discretion of the organizers**.

Prices in red indicate the reduced rate offered by the convention on
those nights. This rate does not apply outside the time of the
convention.
