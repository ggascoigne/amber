...
import { AcnwOrdinal, ConventionYear, ConfigDate, RedStar } from '@/components'
...
<span>*</span> Game Rooms: These are suites reserved for game play.
Members who choose to have a Game room, will receive a {configuration.gameRoomCredit}{' '}
credit towards the room cost.
Be advised that while we will do our best to make sure that the rooms are used for games
you are actually in, in exchange for the credit the game space will be scheduled{' '}
