...
2. there is implicit and explicit content in some games that at least verbally treads in areas normally
...
the most expedient thing to do. You can also report to Simone.
...
### Anonymous Report
  ...
  directly, but we will fully investigate it and take whatever action is necessary to prevent a recurrence.
...
asked to confront anyone and we won't tell anyone who you are. If you do not feel the person you have gone to is right
for you, you can request that an additional or different person be present.
