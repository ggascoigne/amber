...
export const AboutAmberconNw = () => {
  ...
  return (
    <Page>
      <h1>
        About <span className={classes.red}>virtual</span> AmberCon NW
      </h1>
      ...
      <p>
        In addition to these formal slots, there may be additional game events hosted at other times, particularly for
        the UK and European attendees. Those games will be organized separately, though may still use the ACNW server as
        a home base.
      </p>
