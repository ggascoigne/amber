...
export const AntiHarassmentPolicy = () => (
  <Page>
    ...
    <p>
      AmberCon Northwest's policy is adapted from policy samples created by and posted as an open-source resource on the{' '}
      <a href='http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy'>Geek Feminism Wiki</a>. We will
      continue to adapt it each year as our understanding grows.
    </p>
    ...
    <ol>
      ...
      <li>
        there is implicit and explicit content in some games that at least verbally treads in areas normally off-limits
        in wider public spaces.
      </li>
    </ol>

    <p>
      These challenges, however, do not mean we can't have a safe, welcoming convention, and will not discourage us from
      making explicit our support for all attendees to have a harassment-free conference experience.
    </p>
    ...
    <p>
      ...
      in doing so after being notified, you will likely find yourself dis-included for the remainder of the convention.
      If you make anyone in the hotel feel unsafe, you will definitely find yourself dis-included from the convention.
    </p>

    <p>
      Sounds great, but the weakness of such an implicit policy is that people who experience harassment in gaming
      spaces are often made to feel that their experience is accepted by the group in general, or they don't know who to
      report to, or when to do so. (Answers: a designated report person, below, or emergency services, depending on
      need, ASAP.)
    </p>
    ...
    <p>
      AmberCon NW is dedicated to providing a harassment-free conference experience for everyone, regardless of gender,
    ...
    <ul>
      <li>
        ...
        disability, physical appearance, body size, race, age, or religion. (while some games / NPC acting may tread in
        these areas, we suggest explicit and continuing consent from participants--or adjusting your game to dis-include
        such necessities)
      </li>
    ...
    <p>Again, even if you do not believe that your behavior is harassment, if the recipient does, you need to stop.</p>
    ...
    <p>
      ...
      <a href='https://nordiclarp.org/2017/03/24/the-consent-and-community-safety-manifesto/'>
    ...
    <p>
      ...
      make all attendees feel safe and included. If you've read Zelazny's books, however, you know they are full of
      behavior and language and situations that any person could agree would be inappropriate behavior today. Further,
      the "indie-game" community and many of us at AmberCon design games intended to explore difficult social subjects,
      including racism, sexism, violence, mind-control, magic, and oppression.
    </p>

    <p>
      The line between harassment and creative exploration may be fine sometimes. If your game includes such themes, as
      GM, we suggest you first READ THE ABOVE LINK. You should also make your intent to explore such content explicitly
      clear in your game descriptions--as most of you do. As a player, make sure to ask before you introduce such a
      topic into a game. Even so, when such topics are going to arise, you can explicitly offer alternatives, including
      "fade to black."
    </p>
    ...
    <p>
      ...
      ALL--if a player indicates that something is happening in your game that is problematic for them out of character,
      and you persist in doing it, you are doing the wrong thing. You may even be harassing them. AmberCon NW does not
      tolerate harassment.
    </p>
    ...
    <p>
      ...
      the opportunity to say whether the upset is in- or out-of-character, and whether it is something the person wants
      to carry on with or not.
    </p>
    ...
    <p>
      ...
      <a href='https://nordiclarp.org/2015/03/02/bleed-the-spillover-between-player-and-character/'>
    ...
    <p>
      ...
      harassing behavior, event organizers retain the right to take any actions to keep the event a welcoming
      ...
      event or making the environment hostile for any participants. We expect participants to follow these rules in all
      event spaces and event-related social activities. We think people should follow these rules outside event
      activities too!
    </p>
    <p>
    ...
    <p>
      Contact information for these volunteers will be available as part of your registration packet. You can also make
    ...
    <p>
      We don't yet have the ability to take electronic anonymous reports. If you would like to make an anonymous report,
      you can write a note and leave it for Simone Cooper at the front desk. We can't follow up an anonymous report with
      you directly, but we will fully investigate it and take whatever action is necessary to prevent a recurrence.
    </p>
    ...
    <p>
      In case of a safety issue, you may also seek assistance from the hotel staff. The front desk is monitored 24 hours
      a day.
    </p>

    <p>
      If we are taking a report from you in person, you should expect that we will go to a separate room area to ensure
      you are safe and cannot be overheard. If you feel comfortable, we will also involve a second person of your choice
      to ensure your report is managed properly. Once safe, we'll ask you to tell us about what happened. This can be
      upsetting, but we'll handle it as respectfully as possible, and you can bring someone to support you. You won't be
      asked to confront anyone and we won't tell anyone who you are. If you do not feel the person you have gone to is
      right for you, you can request that an additional or different person be present.
    </p>
