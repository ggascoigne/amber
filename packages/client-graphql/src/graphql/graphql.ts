...
export type LookupValue = Node & {
  ...
  /** A globally unique identifier. Can be used in various places throughout the system to identify this single value. */
  nodeId: Scalars['ID']['output']
  numericSequencer: Scalars['Float']['output']
...
export type LookupValueCondition = {
  ...
  numericSequencer?: InputMaybe<Scalars['Float']['input']>
...
export type LookupValueFilter = {
  ...
  numericSequencer?: InputMaybe<FloatFilter>
  /** Checks for any expressions in this list. */
...
export type LookupValueInput = {
  ...
  id?: InputMaybe<Scalars['Int']['input']>
  lookupId: Scalars['Int']['input']
  numericSequencer: Scalars['Float']['input']
