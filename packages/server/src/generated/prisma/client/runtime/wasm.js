...
function it(t, e) {
  ...
  if (((h += k), (S.precision = h), (r = ue(O)), (n = r.charAt(0)), (o = $(A)), Math.abs(o) < 15e14)) {
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); ) (A = A.times(t)), (r = ue(A.d)), (n = r.charAt(0)), C++
...
function wn(t) {
  ...
  function i(o) {
    ...
    if ((o.charCodeAt(0) === 45 ? ((o = o.slice(1)), (s.s = -1)) : (s.s = 1), ps.test(o))) dn(s, o)
...
function F(t, e) {
  let r = new RegExp(`\\x1b\\[${e}m`, 'g'),
    ...
    i = `\x1B[${e}m`
  return function (o) {
    return !fs.enabled || o == null ? o : n + (~('' + o).indexOf(i) ? o.replace(r, i + n) : o) + i
  }
}
var ju = F(0, 0),
  Dt = F(1, 22),
...
function hs(t) {
  let e = { color: Dn[ys++ % Dn.length], enabled: ot.enabled(t), namespace: t, log: ot.log, extend: () => {} },
    r = (...n) => {
...
function bi(t, e) {
  if (e.kind === 'object')
    for (let r of e.fields) t.hasField(r.name) || t.addSuggestion(new re(r.name, r.typeNames.join(' | ')))
}
function dt(t) {
  let e = [...t],
    r = e.pop()
