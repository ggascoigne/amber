...
function Va(e) {
  let t = { color: Ni[ja++ % Ni.length], enabled: xt.enabled(e), namespace: e, log: xt.log, extend: () => {} },
    r = (...n) => {
...
C.logarithm = C.log = function (e) {
  ...
  if (
    ...
    do
      if (((a += 10), (s = ke(f, a)), (n = t ? yr(g, a + 10) : ke(e, a)), (l = q(s, n, a, 1)), !o)) {
  ...
  return (
    ...
    !r.d || !e.s || (e.d && !e.d[0])
      ...
      : !e.d || (r.d && !r.d[0])
        ...
        : ((_ = !1),
          n.modulo == 9 ? ((t = q(r, e.abs(), 0, 3, 1)), (t.s *= e.s)) : (t = q(r, e, 0, n.modulo, 1)),
          (t = t.times(e)),
          (_ = !0),
          r.minus(t))
  )
...
var q = (function () {
  ...
  return function (n, i, o, s, a, l) {
    var f,
      ...
      $ = i.d
    if (!z || !z[0] || !$ || !$[0])
      return new nr(!n.s || !i.s || (z ? $ && z[0] == $[0] : !$) ? NaN : (z && z[0] == 0) || !$ ? Xr * 0 : Xr / 0)
    for (
...
function ke(e, t) {
  ...
  if (
    ...
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); ) (R = R.times(e)), (r = K(R.d)), (n = r.charAt(0)), S++
...
function yo(e) {
  ...
  function i(o) {
    ...
    if (((l = typeof o), l === 'number')) {
      ...
      return fr(f, o.toString())
    }
    if (l === 'string')
      return (
        (a = o.charCodeAt(0)) === 45 ? ((o = o.slice(1)), (f.s = -1)) : (a === 43 && (o = o.slice(1)), (f.s = 1)),
        co.test(o) ? fr(f, o) : Tl(f, o)
      )
    if (l === 'bigint') return o < 0 ? ((o = -o), (f.s = -1)) : (f.s = 1), fr(f, o.toString())
    throw Error(Ie + o)
  }
  if (
    ((i.prototype = C),
