...
function yl(e) {
  let t = { color: Mi[hl++ % Mi.length], enabled: Mt.enabled(e), namespace: e, log: Mt.log, extend: () => {} },
    r = (...n) => {
...
S.minus = S.sub = function (e) {
  ...
  if (((e = new C(e)), !R.d || !e.d))
    return !R.s || !e.s ? (e = new C(NaN)) : R.d ? (e.s = -e.s) : (e = new C(e.d || R.s !== e.s ? R : NaN)), e
...
S.squareRoot = S.sqrt = function () {
  ...
  for (
    ...
    if (((o = n), (n = o.plus(j(s, o, r + 2, 1)).times(0.5)), Y(o.d).slice(0, r) === (t = Y(n.d)).slice(0, r)))
...
S.times = S.mul = function (e) {
  ...
  if (((e.s *= g.s), !v || !v[0] || !R || !R[0]))
    return new h(!e.s || (v && !v[0] && !R) || (R && !R[0] && !v) ? NaN : !v || !R ? e.s / 0 : e.s * 0)
  for (
    r = te(g.e / F) + te(e.e / F),
      l = v.length,
      u = R.length,
...
var j = (function () {
  ...
  return function (n, i, o, s, a, l) {
    var u,
      ...
      $ = i.d
    if (!X || !X[0] || !$ || !$[0])
      return new er(!n.s || !i.s || (X ? $ && X[0] == $[0] : !$) ? NaN : (X && X[0] == 0) || !$ ? Yr * 0 : Yr / 0)
    for (
...
function De(e, t) {
  ...
  if (
    ...
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); ) (A = A.times(e)), (r = Y(A.d)), (n = r.charAt(0)), R++
...
function Lo(e, t) {
  if (t.kind === 'object')
    for (let r of t.fields) e.hasField(r.name) || e.addSuggestion(new ce(r.name, r.typeNames.join(' | ')))
}
function $t(e) {
  let t = [...e],
    r = t.pop()
