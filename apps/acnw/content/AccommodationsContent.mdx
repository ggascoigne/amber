...
import { ConfigurationValue, ConventionOrdinal, ConventionYear, ConfigDate, RedStar } from 'amber/components'
...
a <ConfigurationValue field='gameRoomCredit'/> credit towards the room cost. Be advised that while we will do our best to make sure that
