...
export const configuration: Configuration = {
  ...
  registrationOpen: dtwDate({ year: conventionStartDate.year, month: 7, day: 15 }),
  registrationDeadline: dtwDate({ year: conventionStartDate.year, month: 9, day: 2 }),
  paymentDeadline: dtwDate({ year: conventionStartDate.year, month: 8, day: 12 }),
  gameSubmissionDeadline: dtwDate({ year: conventionStartDate.year, month: 8, day: 15 }),
  gameGmPreview: dtwDate({ year: conventionStartDate.year, month: 9, day: 2 }),
  gameGmFeedbackDeadline: dtwDate({ year: conventionStartDate.year, month: 9, day: 23 }),
  gameBookOpen: dtwDate({ year: conventionStartDate.year, month: 9, day: 5 }),
  gameChoicesDue: dtwDate({ year: conventionStartDate.year, month: 9, day: 25 }),
  gmPreview: dtwDate({ year: conventionStartDate.year, month: 9, day: 28 }),
  schedulesSent: dtwDate({ year: conventionStartDate.year, month: 9, day: 30 }),
  lastCancellationFullRefund: dtwDate({ year: conventionStartDate.year, month: 10, day: 19 }),
