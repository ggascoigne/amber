---
title: Ambercon's Anti-harassment policy
---

Ambercon's policy is adapted from policy samples created by and posted as an open-source resource on
the [Geek Feminism Wiki][geek-feminism-wiki]. We will continue to adapt
it each year as our understanding grows.

You must read and agree to abide by this policy as a condition of attending Ambercon.

Ambercon, as a small RPG convention, faces specific challenges in implementing a formal harassment policy.
...
Ambercon is dedicated to providing a harassment-free conference experience for everyone, regardless of
...
persist in doing it, you are doing the wrong thing. You may even be harassing them. Ambercon does not tolerate
harassment.
...
rinking to excess will NOT be considered a mitigating factor
...
If you feel you or someone else is in immediate danger, go directly to the nearest Hotel staff member (the front
...
can write a note and leave it for the organizers at the front desk. We can't follow up an anonymous report with you
